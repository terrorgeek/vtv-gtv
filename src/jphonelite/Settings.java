...
//      current = new Settings();
//    }
    //TODO change it to load from somewhere (krbi)
    current.lines[0].user = "bob";
    current.lines[0].auth = "bob";
    current.lines[0].pass = "bob";
//    current.lines[0].host = "173.10.173.154:5080";
    current.lines[0].host = "sip.ngb.biz:5080";
      //validate config
    for(int a=0;a<6;a++) {
