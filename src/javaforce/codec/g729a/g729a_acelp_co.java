...
{
    static void g729a_fc_search
	(g729a_encode_internal var_g729a_encode_internal, int i, float f) {
	...
	for (int i_45_ = 3; i_45_ < 5; i_45_++) {
		...
		float f_71_
		    = f_63_ + fs_9_[i_64_] + fs_9_[i_65_] + fs_9_[i_66_];
		i_64_ += 8;
		i_65_ += 8;
		i_66_++;
		int i_72_ = 0;
	...
	var_g729a_encode_internal.S
	    = (short) (i_95_ + 2 * i_96_ + 4 * i_97_ + 8 * i_98_);
	int i_99_ = is[i_18_];
	int i_100_ = i_18_ - i_99_ * 5 == 3 ? 0 : 1;
	var_g729a_encode_internal.C
	    = (short) (is[i_15_] + 8 * is[i_16_] + 64 * is[i_17_]
		       + 512 * (2 * i_99_ + i_100_));
